...
public extension UIColor {
    ...
    /**
        ...
        - parameter red: The red value of the color object. Red values below 0 are interpreted as 0, 
            and values above 255 are interpreted as 255.
        - parameter green: The green value of the color object. Green values below 0 are interpreted as 0, 
            and values above 255 are interpreted as 255.
        - parameter blue: The blue value of the color object. Blue values below 0 are interpreted as 0, 
            and values above 255 are interpreted as 255.
        - parameter transparency: Optional opacity value of the color object, specified as a value from 0.0 to 1.0. 
    ...
    */
    public convenience init(red: Int, green: Int, blue: Int, transparency: CGFloat = 1.0) {
        self.init(
            red: UIColor.normalize(red),
            green: UIColor.normalize(green),
            blue: UIColor.normalize(blue),
            alpha: UIColor.normalize(transparency))
    }
    
    /**
        Initializes and returns a color object using RGB component values as a hexadecimal Int 
            and an optional opacity value.
        - parameter hex: Hexadecimal value for RGB (example: *0xFF0000*).
        - parameter alpha: Optional opacity value of the color object, specified as a value from 0.0 to 1.0. 
            Alpha values below 0.0 are interpreted as 0.0, and values above 1.0 are interpreted as 1.0. 
            It defaults to 1.0.
        - returns: The color object.
    ...
    */
    ...
    /**
        Initializes and returns an optional color object using RGB component values as a hexadecimal String 
            and an optional opacity value.
    ...
    */
    ...
    /**
        ...
        - parameter percent: The percentage for decreasing brightness. Values below 0 are interpreted as 0, 
            and values above 100 are interpreted as 100.
    ...
    */
    ...
    /**
        ...
        - parameter percent: The percentage for increasing brightness. Values below 0 are interpreted as 0, 
            and values above 100 are interpreted as 100.
    ...
    */
    ...
    /**
        Returns a Boolean value that indicates whether a given color is lighter than the receiver 
            (compering their brightness values - from HSBA color space)
    ...
    */
    ...
    /**
        Returns a Boolean value that indicates whether a given color is darker than the receiver 
            (compering their brightness values - from HSBA color space)
        - parameter other: the other color to compare to
...
fileprivate extension UIColor {
    ...
    func brightness(_ amount: CGFloat) -> UIColor {
        ...
        return UIColor.init(
            ...
            brightness: hsba.brightness * amount,
            alpha: hsba.alpha)
    }
